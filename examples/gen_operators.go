...
import (
    "fmt"
	package00 "github.com/gogorch/gorch/examples/opa"
	package02 "github.com/gogorch/gorch/examples/opb"
...
func(o *a0OperatorA0) Execute(ctx *gorch.Context) (err error) {
    if er0 := ctx.MutableIns(&o.Name); er0 != nil {
        return fmt.Errorf("inject github.com/gogorch/gorch/examples/opa.OperatorA0.Name error: %v", er0)
    }
    _ = ctx.MutableIns(&o.Age)
    defer func() {
        if er0 := ctx.RegisterIns(&o.Age, true); er0 != nil {
            err = fmt.Errorf("extract github.com/gogorch/gorch/examples/opa.OperatorA0.Age error: %v", er0)
            return
        }
        o.Age = nil
        o.Name = nil
...
func(o *a1OperatorA1) Execute(ctx *gorch.Context) (err error) {
    ...
    defer func() {
        if er0 := ctx.RegisterIns(&o.Age, true); er0 != nil {
            err = fmt.Errorf("extract github.com/gogorch/gorch/examples/opa.OperatorA1.Age error: %v", er0)
            return
        }
        o.Age = nil
        o.Name = nil
...
func(o *b1OperatorB1) Execute(ctx *gorch.Context) (err error) {
    defer func() {
        if er0 := ctx.RegisterIns(&o.Age, true); er0 != nil {
            err = fmt.Errorf("extract github.com/gogorch/gorch/examples/opb.OperatorB1.Age error: %v", er0)
            return
        }
        o.Age = nil
    }()
